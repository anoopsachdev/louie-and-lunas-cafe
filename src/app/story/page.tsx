    ...
    <div className="pb-24">
      <section className="mx-auto max-w-6xl px-5 pt-14 md:px-8 md:pt-20">
        ...
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-espresso/75 md:text-lg">
          Louie and Luna were once an Indian couple in their forties who loved long
          talks over coffee. One ordinary Delhi afternoon they stayed too long in a
          café that felt older than the city — and somehow became two Persian cats:
          Louie, black as espresso; Luna, white as cream.
        </p>
      ...
      <section className="mx-auto mt-14 grid max-w-6xl items-start gap-10 px-5 md:grid-cols-2 md:px-8">
        ...
        <div className="md:pt-8">
          ...
          <p className="mt-4 text-base leading-relaxed text-espresso/75">
            He likes the darker corners near the wood bar, the richer cups, and people
            who don’t rush. Louie’s coffees take after him — bold, deep, a little
            mysterious, never showy.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto mt-16 grid max-w-6xl items-start gap-10 px-5 md:grid-cols-2 md:px-8">
        <div className="order-2 md:order-1 md:pt-8">
          ...
          <p className="mt-4 text-base leading-relaxed text-espresso/75">
            She claims the sunlit sill and anything floral. Luna’s coffees lean lighter —
            creamy, fragrant, gently fruity — the kind of cup that makes a first date
            feel inevitable.
          </p>
        </div>
      ...
      <section className="mx-auto mt-20 max-w-6xl px-5 md:px-8">
        <div className="max-w-3xl border-l-2 border-brass/60 bg-cream/40 py-8 pr-6 pl-6 md:pl-8">
          ...
          <p className="mt-4 text-base leading-relaxed text-espresso/75">
            ...
            antique mirrors — as if the room refused to modernize. The cats made it
            warmer. Grand rooms alone can feel exclusive; fluffy mascots and laptop
            culture pull the place back to earth.
          </p>
          <p className="mt-4 text-base leading-relaxed text-espresso/75">
            Nobody claims to understand the change. Guests just notice that somewhere
            between the chandelier and the coffee list, Louie and Luna are watching —
            little celebrities of Lodhi Estate.
          </p>
        </div>
        <Button
          nativeButton={false}
